                        ...
                        <div class="card card-body seo my-5 shadow br-8 p-4">
                            <fieldset class="border p-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control br-8" name="seo_keywords" rows="4" placeholder="Enter SEO Keywords">{{ old('seo_keywords', $service->seo_keywords) }}</textarea>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="seo_schema">SEO Schema</label>
                                    <textarea class="form-control br-8" name="seo_schema" rows="4" placeholder="Enter SEO Schema">{{ old('seo_schema', $service->seo_schema) }}</textarea>
                                </div>
                            </fieldset>
                        </div>
                    </div>
                            ...
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="status" name="status">
                                    <option class="p-3" value="0" @if ($service->status == 0) selected @endif>
                                        Draft</option>
                                    <option class="p-3" value="1" @if ($service->status == 1) selected @endif>
                                        Publish</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3 mt-2">
                            ...
                            <div class="custom-file">
                                <input class="dropify @error('image') is-invalid @enderror" id="image"
                                    data-show-remove="false" data-default-file="{{ asset('storage/' . $service->image) }}"
                        ...
                        <div class="form-group mb-3 mt-2">
                            ...
                            <div class="custom-file">
                                <input class="dropify @error('banner_image') is-invalid @enderror" id="banner_image"
                                    ...
                                    data-default-file="{{ asset('storage/' . $service->banner_image) }}" type="file"
                                    name="banner_image">
                                @error('banner_image')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
