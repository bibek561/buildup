                ...
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        ...
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('project') }}">home</a></li>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="project-item wow fadeInUp" data-wow-delay="1.25s">
                        ...
                        <div class="project-image" data-cursor-text="View">
                            <a href="#">
                                <figure>
                                    <img src="{{ asset('frontend/images/our-project-5.jpg') }}" alt="">
                                </figure>
                            </a>
                        </div>
                        <!-- Project Image End -->
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="project-item wow fadeInUp" data-wow-delay="1.5s">
                        ...
                        <div class="project-image" data-cursor-text="View">
                            <a href="#">
                                <figure>
                                    <img src="{{ asset('frontend/images/our-project-6.jpg') }}" alt="">
                                </figure>
                            </a>
                        </div>
                        <!-- Project Image End -->
